			...
			<div id="nav">
				...
				<div id="nav-fixed">
					<div class="container">
						<!-- logo -->
						<div class="nav-logo">
							<a href="welcome" class="logo"><img src="./img/logo.png" alt=""></a>
						</div>
						<!-- /logo -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="section-row">
							...
							<ul class="list-style">
								<li><p><strong>Email:</strong> <a href="#">naluvi382@gmail.com</a></p></li>
								<li><p><strong>Phone:</strong> 087831225912</p></li>
